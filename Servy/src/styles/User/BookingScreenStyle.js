...
export const styles = StyleSheet.create({
  ...
  bkheading: { marginTop: 10, fontSize: 17, color: "#aaa" },
  blacktxt: { marginTop: 20, fontSize: 17, color: "#000" },
  bkdesc: {  fontSize: 17, color: "#aaa" },
  bkdescdate: {
    marginTop: 20,
    fontSize: 22,
    fontWeight: "bold",
  ...
  bookroe: {marginTop: 0,   display:'flex',justifyContent:'flex-start'},
  bookwrap:{  padding: 0, flex: 1, flexDirection: "row"},
  bookwrapti:{padding: 0, flex: 1, },
   bookidet: {  flex: 1,marginTop:10,},
   bookidetimr:{flex: 1,marginTop:12},
   bookidetimrt:{flex: 1,marginTop:0},
   bookidetxt: {marginRight: 10, paddingTop: 15, fontSize: 14},
   bookidetxtdate:{marginRight: 10, paddingTop: 0,fontWeight:'bold'},
   bookidetxttime:{fontSize:28,color:'#60AD7F',fontWeight:'bold'},
